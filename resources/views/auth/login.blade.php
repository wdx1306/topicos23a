    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
         <!--   <p class="card-description text-center">{{ __('O inicie sesión con') }} <strong>admin@material.com</strong> {{ __(' y la contraseña ') }}<strong>secreta</strong> </p> -->
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Vamos') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
